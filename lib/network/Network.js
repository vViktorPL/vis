...
import  HighlightHandler    from "./modules/HighlightHandler";
...
function Network(container, data, options) {
  ...
  this.highlightHandler    = new HighlightHandler(this.body, this.canvas);  // Highlight handler
...
Network.prototype.highlightNodes      = function() {return this.highlightHandler.highlightNodes.apply(this.highlightHandler,arguments);};
Network.prototype.turnOffAllHighlights= function() {
  this.highlightHandler.turnOffAllHighlights.apply(this.highlightHandler,arguments);
  this.redraw();
};
